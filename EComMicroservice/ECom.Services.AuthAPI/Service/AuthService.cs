...
namespace ECom.Services.AuthAPI.Service
{
    public class AuthService : IAuthService
    {
        ...
        public async Task<LoginResponseDto> Login(LoginRequestDto loginRequestDto)
        {
            ...
            UserDto userDTO = new() { Email = user.Email, ID = user.Id, Name = user.Name, PhoneNumber = user.PhoneNumber };
        ...
        public async Task<string> Register(RegisterationRequestDto requestDto)
        {
            ...
            try
            {
                ...
                if (result.Succeeded)
                {
                    var userToReturn = _appDbContext.ApplicationUsers.First(u => u.UserName == requestDto.Email);

                    UserDto userDto = new() { Email = userToReturn.Email, Name = userToReturn.Name, ID = userToReturn.Id, PhoneNumber = userToReturn.PhoneNumber };
